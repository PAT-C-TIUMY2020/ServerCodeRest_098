...
namespace ServerCodeRest_098_Nashrul.ServiceReference1 {
    ...
    public interface ITI_UMY {
        ...
        ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa[] GetAllMahasiswa();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITI_UMY/GetAllMahasiswa", ReplyAction="http://tempuri.org/ITI_UMY/GetAllMahasiswaResponse")]
        System.Threading.Tasks.Task<ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa[]> GetAllMahasiswaAsync();
        ...
        ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa GetMahasiswaByNIM(string nim);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITI_UMY/GetMahasiswaByNIM", ReplyAction="http://tempuri.org/ITI_UMY/GetMahasiswaByNIMResponse")]
        System.Threading.Tasks.Task<ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa> GetMahasiswaByNIMAsync(string nim);
        ...
        string CreateMahasiswa(ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa mhs);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITI_UMY/CreateMahasiswa", ReplyAction="http://tempuri.org/ITI_UMY/CreateMahasiswaResponse")]
        System.Threading.Tasks.Task<string> CreateMahasiswaAsync(ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa mhs);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITI_UMYChannel : ServerCodeRest_098_Nashrul.ServiceReference1.ITI_UMY, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TI_UMYClient : System.ServiceModel.ClientBase<ServerCodeRest_098_Nashrul.ServiceReference1.ITI_UMY>, ServerCodeRest_098_Nashrul.ServiceReference1.ITI_UMY {
        ...
        public ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa[] GetAllMahasiswa() {
            return base.Channel.GetAllMahasiswa();
        }
        
        public System.Threading.Tasks.Task<ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa[]> GetAllMahasiswaAsync() {
            return base.Channel.GetAllMahasiswaAsync();
        }
        
        public ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa GetMahasiswaByNIM(string nim) {
            return base.Channel.GetMahasiswaByNIM(nim);
        }
        
        public System.Threading.Tasks.Task<ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa> GetMahasiswaByNIMAsync(string nim) {
            return base.Channel.GetMahasiswaByNIMAsync(nim);
        }
        
        public string CreateMahasiswa(ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa mhs) {
            return base.Channel.CreateMahasiswa(mhs);
        }
        
        public System.Threading.Tasks.Task<string> CreateMahasiswaAsync(ServerCodeRest_098_Nashrul.ServiceReference1.Mahasiswa mhs) {
